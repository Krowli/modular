...
import type { GeneratedProvider } from "@modular/pi-catalog/models";
import { getBundledModel } from "@modular/pi-catalog/models";
import { getConfigRootDir, getStatsDbPath } from "@modular/pi-utils";
...
export async function initDb(): Promise<Database> {
	...
	// https://github.com/Krowli/modular/issues/2421.
 ...
 * `createBranchedSession()` in `@modular/pi-coding-agent`) deep-copy a parent
