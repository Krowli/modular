...
import { formatDuration, formatNumber, formatPercent } from "@modular/pi-utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
modular-stats - AI Usage Statistics Dashboard

Usage:
  modular-stats [options]
...
Examples:
  modular-stats              # Start dashboard server
  modular-stats --json       # Print stats as JSON
  modular-stats --port 8080  # Start on custom port
  modular-stats --sync       # Sync and show summary
`);
		return;
	}
