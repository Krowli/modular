/**
 * Shared chart primitives for the dashboard timeline charts: the MODULAR color
...
// MODULAR brand palette (packages/collab-web/src/styles/tokens.css): pink/purple/cyan.
// Categorical series lead with the brand gradient hues (pink -> purple -> cyan).
export const MODEL_COLORS = [
	"#22c55e", // brand pink (accent)
	"#4ade80", // brand violet
	"#909090", // brand cyan
	"#16a34a", // green
	"#808080", // light purple
