...
/**
 * Per-agent-type display chrome. Colors follow the MODULAR brand palette
...
const AGENT_META: Record<AgentType, { label: string; color: string }> = {
	main: { label: "Main agent", color: "#22c55e" },
	subagent: { label: "Subagents", color: "#4ade80" },
	advisor: { label: "Advisor", color: "#909090" },
};
