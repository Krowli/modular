...
import { smokeTestSyncWorker } from "@modular/modular-stats/aggregator";
...
describe("smokeTestSyncWorker", () => {
	it("skips the worker spawn on darwin so modular --smoke-test stays off the macOS abort surface", async () => {
