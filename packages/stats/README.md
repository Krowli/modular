# @modular/modular-stats

Local observability dashboard for AI usage statistics.

## Features

- **Session log parsing**: Reads JSONL session logs from `~/.modular/agent/sessions/`
...
# Custom port
modular stats --port 8080

# Print summary to console
modular stats --summary
...
```typescript
import { getDashboardStats, syncAllSessions } from "@modular/modular-stats";
...
- **Session logs**: `~/.modular/agent/sessions/` (JSONL files)
- **Stats database**: `~/.modular/stats.db` (SQLite)
