...
import { isVertexExpressOpenAIUrl, isVertexRawPredictUrl } from "@modular/pi-catalog/hosts";
import {
	...
	resolveWireModelId,
} from "@modular/pi-catalog/model-thinking";
import { CATALOG_PROVIDERS, type ProviderCatalogEntry } from "@modular/pi-catalog/provider-models";
import { CODEX_BASE_URL } from "@modular/pi-catalog/wire/codex";
import { $env, $pickenv, getConfigRootDir, isEnoent, logger, withExtraCaFetch } from "@modular/pi-utils";
 ...
 * Used by `modular auth-broker migrate --include-env` to discover env-sourced keys
