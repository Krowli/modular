 ...
 * (containerized modular, the swarm extension, robodular's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer modular builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized modular → host gateway, robodular slot → modular-auth-gateway
