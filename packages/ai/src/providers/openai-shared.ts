import type { Effort } from "@modular/pi-catalog/effort";
import { toFirepassWireModelId, toFireworksWireModelId } from "@modular/pi-catalog/fireworks-model-id";
import { isGlm52ReasoningEffortModelId } from "@modular/pi-catalog/identity";
import { getSupportedEfforts } from "@modular/pi-catalog/model-thinking";
import { calculateCost } from "@modular/pi-catalog/models";
import type {
	OpenAICompat,
 ...
 * Built once per request; `apply_patch` → `edit` is the MODULAR default.
 */
...
export async function processResponsesStream<TApi extends Api>(
	...
	// see https://github.com/Krowli/modular/issues/1880 — llama.cpp emits parallel
