// Regression for https://github.com/Krowli/modular/issues/1880.
//
...
import { processResponsesStream } from "@modular/pi-ai/providers/openai-shared";
import type { AssistantMessage, Model } from "@modular/pi-ai/types";
