 ...
 *
 * `modular-llm-request-15179edfab4dc557.json` plus the rr-session captures from the
 * reporter showed:
 *
 ...
 * thinking output). The MODULAR-side `Context` preserved those as a
...
import { renderDemotedThinking } from "@modular/pi-ai/dialect";
import { convertMessages } from "@modular/pi-ai/providers/openai-completions";
import {
	applyChatCompletionsReasoningParams,
	type OpenAICompletionsParams,
} from "@modular/pi-ai/providers/openai-shared";
import type { AssistantMessage, Message, Model, ModelSpec, ThinkingContent, UserMessage } from "@modular/pi-ai/types";
...
describe("llama.cpp warm-prefix preservation (#3528)", () => {
	...
	it("leaves qwenPreserveThinking off for cloud Qwen hosts", () => {
		...
		// cloud side; MODULAR isn't responsible for KV-cache invalidation there,
