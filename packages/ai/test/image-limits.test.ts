...
import type { Api, Context, ImageContent, Model, OptionsForApi, UserMessage } from "@modular/pi-ai/types";
import { getBundledModel } from "@modular/pi-catalog/models";
import { $which, removeSyncWithRetries } from "@modular/pi-utils";
import { e2eApiKey } from "./oauth";

const TEMP_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "modular-temp-images-"));
