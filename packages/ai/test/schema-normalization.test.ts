...
import { buildRequest } from "@modular/pi-ai/providers/google-gemini-cli";
import { convertTools } from "@modular/pi-ai/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@modular/pi-ai/types";
import {
	enforceStrictSchema,
