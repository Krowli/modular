...
import type { Api, Context, Model, ModelSpec } from "@modular/pi-ai/types";
import { buildModel } from "@modular/pi-catalog/build";
import { COPILOT_API_HEADERS } from "@modular/pi-catalog/wire/github-copilot";
 ...
 * hint (an modular extension that preserves native-resolution snapcompact
