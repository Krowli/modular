...
import type { Api, Context, Model, OptionsForApi, ToolResultMessage } from "@modular/pi-ai/types";
...
- Thinking face: 🤔
- Rocket: 🚀
- Mixed text: Modular wann? Wo? Bin grad äußersr eventuninformiert 🙈
- Japanese: こんにちは
- Chinese: 你好
...
=> {
  "comments": [
    ...
    {
      "author": "Matthias Neumayer's  graphic link",
      "text": "Modular wann? Wo? Bin grad äußersr eventuninformiert 🙈"
    }
  ]
}`,
			},
