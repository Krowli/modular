 ...
 * that powers `modular auth-gateway check`. Contract under test:
 *
...
import type { UsageProvider } from "@modular/pi-ai/usage";
import * as claudeUsage from "@modular/pi-ai/usage/claude";
import { opencodeGoUsageProvider } from "@modular/pi-ai/usage/opencode-go";
