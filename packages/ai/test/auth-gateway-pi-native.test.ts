...
import { encodeStream, formatError, parseRequest } from "@modular/pi-ai/providers/pi-native-server";
import type {
	AssistantMessage,
...
describe("pi-native encodeStream", () => {
	it("ships every AssistantMessageEvent verbatim, terminated by [DONE]", async () => {
		// Pi-native is modular-talks-to-modular: the client feeds parsed events directly
