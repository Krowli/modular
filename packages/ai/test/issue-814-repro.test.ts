...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@modular/pi-ai/types";
 ...
 * carries `tool_use_id`. As a workaround, MODULAR must include `id` (aliased to
