...
import type { Model } from "@modular/pi-ai/types";
...
export const AUTH_GATEWAY_E2E_URL = Bun.env.MODULAR_E2E_GATEWAY_URL ?? "http://127.0.0.1:4000";

const AUTH_GATEWAY_TOKEN_PATH = path.join(os.homedir(), ".modular", "auth-gateway.token");
