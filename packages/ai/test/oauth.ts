/**
 * Test helper for resolving API keys from ~/.modular/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@modular/pi-ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@modular/pi-ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@modular/pi-utils";
...
/**
 * Resolve API key for a provider from ~/.modular/agent/testauth.db
 *
