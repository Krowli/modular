...
import type { AssistantMessage, Message, Model, UserMessage } from "@modular/pi-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.modular/logs/http-400-requests/*.json` after Claude
