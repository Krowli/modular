/**
 * Issue #2113 — `kimik2 does not work on the latest modular`
 *
...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@modular/pi-ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@modular/pi-ai/types";
...
import { moonshotModelManagerOptions } from "@modular/pi-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "@modular/pi-catalog/types";
