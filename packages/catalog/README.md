...
Model catalog for [modular](https://github.com/Krowli/modular): bundled model database, provider discovery, model identity, classification, and equivalence.
...
Import from subpaths (`@modular/pi-catalog/<module>`) or the root barrel.
