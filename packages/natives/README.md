...
```typescript
import { grep, find, encodeSixel } from "@modular/pi-natives";
...
`@modular/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @modular/pi-natives-<platform>-<arch>
