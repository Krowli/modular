/**
 * Swarm agent execution via modular's subagent infrastructure.
 *
...
import { runSubprocess } from "@modular/pi-coding-agent";
...
/**
 * Execute a single swarm agent as an modular subagent.
 *
 * The agent receives:
