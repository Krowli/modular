 ...
 * then use /swarm in any modular session.
 */

import * as fs from "node:fs/promises";
import * as path from "node:path";
import type { ExtensionAPI, ExtensionCommandContext } from "@modular/pi-coding-agent";
import { formatDuration } from "@modular/pi-utils";
