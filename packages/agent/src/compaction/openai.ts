...
import { ProviderHttpError } from "@modular/pi-ai/error";
...
import { parseAzureDeploymentNameMap, parseTextSignature } from "@modular/pi-ai/providers/openai-shared";
import { transformMessages } from "@modular/pi-ai/providers/transform-messages";
import type {
	Api,
	AssistantMessage,
...
} from "@modular/pi-ai/utils";
import {
	CODEX_BASE_URL,
	getCodexAccountId,
	OPENAI_HEADER_VALUES,
	OPENAI_HEADERS,
} from "@modular/pi-catalog/wire/codex";
import { $env, logger, stringifyJson } from "@modular/pi-utils";
 ...
 * either a purpose-built modular summarizer (`{systemPrompt, prompt}` → `{summary}`)
 ...
 * issue #4630: without this, the modular payload was rejected with
