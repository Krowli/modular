...
import type { SessionEntry, SessionMessageEntry, ShakeConfig } from "@modular/pi-agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolCall, ToolResultMessage } from "@modular/pi-ai";
