...
import type { SessionEntry, SessionMessageEntry } from "@modular/pi-agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolResultMessage } from "@modular/pi-ai";
