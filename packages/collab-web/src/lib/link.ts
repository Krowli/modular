 ...
 * link/envelope half of `@modular/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@modular/pi-wire";
import {
	DEFAULT_RELAY_URL,
	...
	ROOM_KEY_BYTES,
	WRITE_TOKEN_BYTES,
} from "@modular/pi-wire";

export { COLLAB_PROTO } from "@modular/pi-wire";
