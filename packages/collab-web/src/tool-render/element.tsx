/**
 * `<modular-tool-view>` — web-component wrapper around ToolView for non-React
...
export class ModularToolViewElement extends HTMLElement {
	#root: Root | null = null;
...
export function defineToolViewElement(tag = "modular-tool-view"): void {
	if (!customElements.get(tag)) customElements.define(tag, ModularToolViewElement);
}
