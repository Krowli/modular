 ...
 * of the fixture JSONL — exactly the frames a real `modular /collab` host emits.
 */

import type { AgentSnapshot, HostFrame, SessionEntry, SessionState, WireFrame } from "@modular/pi-wire";
