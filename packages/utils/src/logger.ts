/**
 * Centralized logger for modular.
 *
 * Default: rotating `~/.modular/logs/modular.<DATE>.log`, no console output (writing
 ...
 *
 * Each entry includes `process.pid` so concurrent modular instances stay
 * traceable.
 */
