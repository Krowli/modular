import { $env, logger } from "@modular/pi-utils";
 ...
 */
export const TINY_WORKER_ARG = "__modular_worker_tiny_inference";
...
function readTinyModelSetting(path: "providers.tinyModelDevice" | "providers.tinyModelDtype"): string | undefined {
	try {
		...
		// Settings may be uninitialized (e.g. `modular --smoke-test`); fall back to env/default.
		return undefined;
	}
}
