...
import { isEnoent, postmortem } from "@modular/pi-utils";
import { daemonRuntimeDir } from "./paths";

const CLIENTS_DIR = "clients";

/** Handle keeping one modular process registered in a project daemon scope. */
...
/** Register this modular process so project daemons survive while it remains alive. */
...
/** Return whether a registered modular process in this runtime directory is still alive. */
