...
export const DAEMON_BROKER_WORKER_ARG = "__modular_worker_daemon_broker";
...
export const DAEMON_PROJECT_DIR_ENV = "MODULAR_DAEMON_PROJECT_DIR";

/** Environment key carrying the broker's private runtime directory. */
export const DAEMON_RUNTIME_DIR_ENV = "MODULAR_DAEMON_RUNTIME_DIR";

/** Optional environment key overriding last-client shutdown grace. */
export const DAEMON_IDLE_GRACE_ENV = "MODULAR_DAEMON_IDLE_GRACE_MS";
