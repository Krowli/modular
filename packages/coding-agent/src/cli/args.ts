 ...
 */
import { APP_NAME, CONFIG_DIR_NAME, logger } from "@modular/pi-utils";
 ...
 * setter table itself can stay free of `@modular/pi-utils` runtime imports
...
export function getExtraHelpText(): string {
  ...
  MODULAR_PROFILE                 - Named profile for isolated agent state (same as --profile)
  Use \`modular --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  modular agents unpack           - Export bundled subagents to ~/.modular/agent/agents (default)
  modular agents unpack --project - Export bundled subagents to ./.modular/agents`;
}
