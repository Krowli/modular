 ...
 *
 * Handles `modular setup` for onboarding and `modular setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { $which, APP_NAME, getProjectDir, getPythonEnvDir } from "@modular/pi-utils";
import { $ } from "bun";
...
// package dependencies beyond a working interpreter. `modular setup python --check`
...
/**
 * Unified `modular setup speech` flow. Drives every {@link SpeechComponent} through
