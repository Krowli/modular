 ...
 * primitive in `@modular/pi-natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@modular/hashline";
import { blockRangeAt } from "@modular/pi-natives";
