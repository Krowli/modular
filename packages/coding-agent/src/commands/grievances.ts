...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `modular grievances` invocation working unchanged
	...
	static examples = [
		"modular grievances",
		"modular grievances list --tool find",
		"modular grievances clean --id 209",
		"modular grievances clean --tool find",
		"modular grievances clean --all",
		"modular grievances push",
	];
