...
export default class Bench extends Command {
	...
	static examples = [
		"# Compare two models\n  modular bench anthropic/claude-opus-4-5 openai/gpt-5.2",
		"# Fuzzy selectors work\n  modular bench opus sonnet",
		"# Average over 3 runs each\n  modular bench opus gpt-5.2 --runs 3",
		"# Force priority serving tier\n  modular bench openai-codex/gpt-5.5:low --runs 10 --service-tier priority",
		"# Machine-readable output\n  modular bench opus --json",
	];
