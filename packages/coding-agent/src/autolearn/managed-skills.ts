 ...
 * isolated directory (`~/.modular/agent/managed-skills`) separate from
 * user-authored skills (`~/.modular/agent/skills`). They are discovered and
...
import { getAgentDir, isEnoent } from "@modular/pi-utils";
import { YAML } from "bun";

/** Provider id stamped on discovered managed skills (distinguishes them from authored). */
export const MANAGED_SKILLS_PROVIDER_ID = "modular-managed";
...
/** Resolve the isolated managed-skills directory (`~/.modular/agent/managed-skills`). */
