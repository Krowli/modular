...
import { getProjectDir, isEnoent, logger, prompt } from "@modular/pi-utils";
 ...
 * ACP deployment shape of an editor spawning modular as a co-hosted subprocess.
 */
...
export class BashTool implements AgentTool<typeof bashSchemaBase | typeof bashSchemaWithAsync, BashToolDetails> {
	...
	async execute(
		...
		// must still cancel the call or job, but MODULAR does not impose a deadline.
