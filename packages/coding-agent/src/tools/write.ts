...
import { formatHashlineHeader, stripHashlinePrefixes } from "@modular/hashline";
import type {
	AgentTool,
	AgentToolContext,
	AgentToolResult,
...
import { isEnoent, isRecord, prompt, untilAborted } from "@modular/pi-utils";
...
export class WriteTool implements AgentTool<typeof writeSchema, WriteToolDetails> {
	...
	async execute(
		...
		return untilAborted(signal, async () => {
			...
			// artifacts such as local:// plans are owned by MODULAR, not the editor.
