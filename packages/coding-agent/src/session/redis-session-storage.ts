import { logger, toError } from "@modular/pi-utils";
import {
...
export interface RedisSessionStorageOptions {
	...
	/**
	 * Key prefix applied to every Redis key this storage owns. Default `modular:sessions:`.
...
const DEFAULT_PREFIX = "modular:sessions:";
