...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@modular/pi-ai";
...
// Per-provider image-count budgets live in @modular/snapcompact
