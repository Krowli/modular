...
import type { Api, ApiKey, Model } from "@modular/pi-ai";
import { getProjectDir, logger, prompt } from "@modular/pi-utils";
...
/**
 * Execute the modular commit pipeline for staged changes.
 */
