 ...
 * `@modular/pi-ai` (or one of its aliased scopes like `@modular/pi-ai`
 * or `@modular/pi-ai`).
 *
 ...
 * bare package root. Subpath imports (`@modular/pi-ai/oauth`, etc.)
 ...
 * `@modular/pi-catalog/models`. `getModel`/`getModels` are the historical
