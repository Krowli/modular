...
import type { CompactionPreparation, CompactionResult } from "@modular/pi-agent-core/compaction";
import type { AssistantRetryRecovery, ImageContent, TextContent, ToolResultMessage } from "@modular/pi-ai";
...
export interface SessionStopEventResult {
	...
	continue?: boolean;
	/** MODULAR-native model-visible context for the continuation */
