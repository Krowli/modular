...
import type { CompactionResult } from "@modular/pi-agent-core/compaction";
import type { FetchImpl, Model, Static, TSchema } from "@modular/pi-ai";
import type { Component } from "@modular/pi-tui";
import type { logger as PiLogger } from "@modular/pi-utils";
...
export interface CustomToolContext {
	...
	fetch?: FetchImpl;
	/** Calling session's `local://` root mapping for tools that bridge out of the MODULAR process. */
