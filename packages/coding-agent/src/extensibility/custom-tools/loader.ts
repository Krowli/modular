 ...
 * `.modular/tools/`, `.claude/tools/`, the plugin tree, and any configured paths.
 *
...
export async function discoverCustomToolPaths(configuredPaths: string[], cwd: string): Promise<ToolPathWithSource[]> {
	...
	// 2. Plugin tools: ~/.modular/plugins/node_modules/*/
 ...
 * 2. Installed plugins (~/.modular/plugins/node_modules/*)
