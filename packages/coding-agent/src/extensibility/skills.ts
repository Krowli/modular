...
import { getProjectDir, prompt } from "@modular/pi-utils";
import {
...
export async function loadSkills(options: LoadSkillsOptions = {}): Promise<LoadSkillsResult> {
	...
	// third-party toggles count here: the MODULAR-native providers (`agents`,
	...
	function isSourceEnabled(source: SourceMeta): boolean {
		...
		// Managed skills (auto-learn) are MODULAR-native and discovered unconditionally
