...
import { PASTE_CODE_LOGIN_PROVIDERS } from "@modular/pi-ai";
import { getOAuthProviders } from "@modular/pi-ai/oauth";
import type { OAuthProvider } from "@modular/pi-ai/oauth/types";
import type { Component, OverlayHandle } from "@modular/pi-tui";
import { Loader, Spacer, setTuiTight, Text } from "@modular/pi-tui";
import { getAgentDbPath, getAgentDir, getProjectDir, normalizePathForComparison } from "@modular/pi-utils";
import {
