...
import { APP_NAME } from "@modular/pi-utils";
...
/**
 * Premium welcome screen with block-based MODULAR logo and two-column layout.
 */
...
const GRADIENT_STOPS: ReadonlyArray<readonly [number, number, number]> = [
	[21, 87, 46], // deep emerald
	[34, 150, 74], // green
	[34, 197, 94], // signature #22c55e
	[74, 222, 128], // light green
	[187, 247, 208], // mint highlight
];

/** 256-color ramp fallback when truecolor isn't available. */
const GRADIENT_RAMP_256 = [22, 28, 34, 40, 76, 82, 120];
