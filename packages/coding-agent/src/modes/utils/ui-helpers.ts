...
import type { AssistantMessage, ImageContent, Message, Usage } from "@modular/pi-ai";
import { getStreamingPartialJson } from "@modular/pi-ai/utils/block-symbols";
import { type Component, Spacer, Text, TruncatedText } from "@modular/pi-tui";
		...
		block.addChild(
			new Text(
				theme.bold(theme.fg("warning", "Update Available")) +
					...
					theme.fg("accent", "modular update"),
				1,
				0,
			),
		);
