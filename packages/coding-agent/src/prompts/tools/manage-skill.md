Create, update, or delete a managed skill — a `SKILL.md` written to an isolated directory (`~/.modular/agent/managed-skills`) and surfaced like a normal skill in future sessions.
