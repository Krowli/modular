/**
 * Web/export palette — the modular brand identity shared by the collab-web live
 * client (`my.modularcli.com/`) and every public HTML export / share viewer (`/s/<id>`).
 *
 ...
 * colors for every modular user. The public web artifacts want the collab-web
