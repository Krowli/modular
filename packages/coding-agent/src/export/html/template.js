    (function() {
      ...
      // ============================================================
      //
      // Tool calls render through the bundled <modular-tool-view> web component
      ...
      function renderToolCall(call, sctx) {
        ...
        return '<modular-tool-view class="tool-execution ' + statusClass + '" data-key="' + key + '" open></modular-tool-view>';
      }
