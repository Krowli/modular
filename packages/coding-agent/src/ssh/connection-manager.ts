...
import { $which, getRemoteHostDir, getSshControlDir, isEnoent, logger, postmortem, ptree } from "@modular/pi-utils";
...
export interface SSHHostInfo {
	...
	shell: SSHHostShell;
	/**
	 * Shell name MODULAR verified can execute the POSIX transfer snippets
