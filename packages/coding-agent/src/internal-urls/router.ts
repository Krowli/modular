/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `modular://`, `pr://`, `rule://`, `skill://`, `ssh://`, and `vault://`).
 *
...
import { ModularProtocolHandler } from "./modular-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new ModularProtocolHandler());
