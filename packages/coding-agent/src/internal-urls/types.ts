 ...
 *
 * Internal URLs (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `modular://`, `pr://`, `rule://`, `skill://`, `ssh://`, and `vault://`) are resolved by tools like read,
...
export interface ResolveContext {
	 ...
	 * [#1608](https://github.com/Krowli/modular/issues/1608).
	 */
