...
import { registerCustomApi, unregisterCustomApis } from "@modular/pi-ai/api-registry";
import type {
	Api,
	Context,
	Model,
...
import type { AssistantMessageEventStream } from "@modular/pi-ai/utils/event-stream";
import { buildModel } from "@modular/pi-catalog/build";
import { isVertexExpressOpenAIUrl } from "@modular/pi-catalog/hosts";
import { readModelCache } from "@modular/pi-catalog/model-cache";
import {
	createModelManager,
	type ModelManagerOptions,
	type ModelRefreshStrategy,
} from "@modular/pi-catalog/model-manager";
import { getBundledModels, getBundledProviders } from "@modular/pi-catalog/models";
import {
	googleAntigravityModelManagerOptions,
	googleGeminiCliModelManagerOptions,
	openaiCodexModelManagerOptions,
	PROVIDER_DESCRIPTORS,
} from "@modular/pi-catalog/provider-models";
import {
	collapseBuiltModelVariants,
	getVariantAliasSources,
	resolveVariantAlias,
} from "@modular/pi-catalog/variant-collapse";
...
import type { ApiKeyResolver, FetchImpl } from "@modular/pi-ai";
import { registerOAuthProvider, unregisterOAuthProviders } from "@modular/pi-ai/oauth";
import type { OAuthCredentials, OAuthLoginCallbacks } from "@modular/pi-ai/oauth/types";
import { getBundledModelReferenceIndex, resolveModelReference } from "@modular/pi-catalog/identity";
import { isBunTestRuntime, isRecord, logger, wrapFetchForExtraCa } from "@modular/pi-utils";
...
export class ModelRegistry {
	 ...
	 *
	 * Mirrors the upstream `@modular/pi-coding-agent` API surface so that
