 ...
 */
import { type ApiKey, type FetchImpl, withAuth } from "@modular/pi-ai";
import type { Api, Model, RemoteCompactionConfig } from "@modular/pi-ai/types";
import { buildModel } from "@modular/pi-catalog/build";
import {
	getBundledModelReferenceIndex,
	resolveModelReference,
	stripBracketedModelIdAffixes,
} from "@modular/pi-catalog/identity";
import {
...
} from "@modular/pi-catalog/provider-models/openai-compat";
import type { ModelSpec, OpenAICompat } from "@modular/pi-catalog/types";
import { isRecord } from "@modular/pi-utils";
