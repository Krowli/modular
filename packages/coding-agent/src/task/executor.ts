...
import type { AgentEvent, AgentIdentity, AgentTelemetryConfig } from "@modular/pi-agent-core";
import { recordHandoff, resolveTelemetry } from "@modular/pi-agent-core";
import type { Api, Model, ServiceTierByFamily, Usage } from "@modular/pi-ai";
import { logger, popLoopPhase, prompt, pushLoopPhase, untilAborted } from "@modular/pi-utils";
...
export interface ExecutorOptions {
	 ...
	 * `.modular/tools/` FS scan in the subagent; the subagent then re-binds each
