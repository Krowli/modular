...
import { type ApiKeyResolver, completeSimple } from "@modular/pi-ai";
import { hostMatchesUrl } from "@modular/pi-catalog/hosts";
import type { Mnemopi } from "@modular/pi-mnemopi";
import type * as MnemopiDiagnoseNs from "@modular/pi-mnemopi/diagnose";
import type { DiagnosticSummary } from "@modular/pi-mnemopi/diagnose";
...
async function loadMnemopiDiagnose(): Promise<typeof MnemopiDiagnoseNs> {
	if (!mnemopiDiagnoseMod) {
		mnemopiDiagnoseMod = await import("@modular/pi-mnemopi/diagnose");
	}
