 ...
 * `__modular_worker_mnemopi_embed` selector). The whole point of this module is
...
import type { StandardEmbeddingModel } from "@modular/pi-mnemopi/core";
import { loadFastembed } from "@modular/pi-mnemopi/core/fastembed-runtime";
