import { getLastChangelogVersionPath, isEnoent, logger } from "@modular/pi-utils";
 ...
 * #1423 (the host project's `CHANGELOG.md` was rendered as modular's).
 */
...
/**
 * Parse an modular changelog marker version into comparable parts.
 */
...
/**
 * Last modular version whose changelog the user has seen. Stored as a plain-text
 * marker file (`~/.modular/agent/last-changelog-version`) rather than in
