...
import { type Api, type AssistantMessage, completeSimple, type Model } from "@modular/pi-ai";
import { StreamMarkupHealing } from "@modular/pi-ai/utils/stream-markup-healing";
import { isTerminalHeadless, logger, prompt } from "@modular/pi-utils";
...
const TITLE_VISIBILITY_SENTINEL = "\uE000modular-title-visible\uE000";
