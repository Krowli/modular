 ...
 *
 * Usage:
 * 1. Copy this file to ~/.modular/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .modular/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "@modular/pi-coding-agent";
import { getSettingsListTheme } from "@modular/pi-coding-agent";
import { Container, type SettingItem, SettingsList } from "@modular/pi-tui";
