 ...
 *
 * Usage:
 *   modular --hook examples/hooks/custom-compaction.ts
 */
import { complete, getModel } from "@modular/pi-ai";
import type { HookAPI } from "@modular/pi-coding-agent";
import { convertToLlm, serializeConversation } from "@modular/pi-coding-agent";
