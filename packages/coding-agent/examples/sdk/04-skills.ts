 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@modular/pi-coding-agent";

// Discover all skills from cwd/.modular/skills, ~/.modular/agent/skills, etc.
