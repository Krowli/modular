 ...
 * - ~/.modular/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.modular/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.modular/agent/extensions/ or .modular/extensions/
