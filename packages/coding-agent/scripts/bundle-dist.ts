...
// `modular-legacy-pi-modules` exists only in compiled binaries via the build plugin;
...
async function cleanBundleOutputs(): Promise<void> {
	// dist/ is shared with the dev binary (dist/modular); only remove this
