#!/usr/bin/env bun
/**
 * Build the standalone share-viewer page the modular relay serves at `GET /s/<id>`.
 *
...
// Pin the modular brand palette (collab-web pink/purple identity) — the viewer is
// a public artifact matching the live my.modularcli.com client, not a per-user export
...
const html = getTemplate()
	...
	.replace("<title>Session Export</title>", () => "<title>modular session</title>")
