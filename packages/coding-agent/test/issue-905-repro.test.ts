 ...
 *
 * Contract under test: the `modular models` listing entry point loads extensions
...
import { runModelsListing } from "@modular/pi-coding-agent/cli/models-cli";
...
test("modular models surfaces extension-registered providers (issue #905)", async () => {
...
test("modular models prints invalid models.yml schema errors before listing output", async () => {
