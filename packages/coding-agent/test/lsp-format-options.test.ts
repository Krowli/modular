...
import { detectIndentFromContent, resolveFormatOptions } from "@modular/pi-coding-agent/lsp/format-options";
import { getProjectDir, removeWithRetries, Snowflake, setProjectDir } from "@modular/pi-utils";
