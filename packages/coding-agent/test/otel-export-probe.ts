...
} from "@modular/pi-coding-agent/telemetry-export";
...
process.env.OTEL_SERVICE_NAME = "modular-export-probe";
...
const span = trace.getTracer("@modular/pi-agent-core").startSpan("agent.llm_call");
