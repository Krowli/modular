...
import { importRoomKey } from "@modular/pi-coding-agent/collab/crypto";
...
import { MAX_REPLICATED_PAYLOAD_BYTES, shrinkForReplication } from "@modular/pi-coding-agent/collab/replication-shrink";
...
/**
 * Single-room relay mirroring the modular-collab-relay forwarding contract, with
