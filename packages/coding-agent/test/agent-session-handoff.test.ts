...
import { Agent, type AgentMessage, type StreamFn } from "@modular/pi-agent-core";
import * as compactionModule from "@modular/pi-agent-core/compaction";
import type { AssistantMessage, Model, ToolCall } from "@modular/pi-ai";
...
import { ExtensionRunner, loadExtensions } from "@modular/pi-coding-agent/extensibility/extensions";
import { SecretObfuscator } from "@modular/pi-coding-agent/secrets";
