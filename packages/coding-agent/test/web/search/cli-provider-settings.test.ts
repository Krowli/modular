...
} from "@modular/pi-coding-agent/web/search/provider";
import { __resetDirsFromEnvForTests, setAgentDir, TempDir } from "@modular/pi-utils";
...
beforeEach(async () => {
	...
	setExcludedSearchProviders([]);
	tempAgentDir = TempDir.createSync("@modular-search-cli-");
