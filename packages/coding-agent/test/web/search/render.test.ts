...
import { renderSearchResult, type SearchRenderDetails } from "@modular/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@modular/pi-coding-agent/web/search/types";
