...
import { resizeImage } from "@modular/pi-coding-agent/utils/image-resize";
...
describe("resizeImage env wiring", () => {
	...
	it("treats MODULAR_NO_WEBP=1 set at call time as exclusion (not baked at module load)", async () => {
		Bun.env.MODULAR_NO_WEBP = "1";
