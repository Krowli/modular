...
import { Agent, type AgentTool } from "@modular/pi-agent-core";
import type { Model } from "@modular/pi-ai";
import { buildModel } from "@modular/pi-catalog/build";
import { reset as resetCapabilities } from "@modular/pi-coding-agent/capability";
import { type SSHHost, sshCapability } from "@modular/pi-coding-agent/capability/ssh";
...
import { addSSHHost, removeSSHHost, updateSSHHost } from "@modular/pi-coding-agent/ssh/config-writer";
import * as connectionManager from "@modular/pi-coding-agent/ssh/connection-manager";
import { loadSshTool, type ToolSession } from "@modular/pi-coding-agent/tools";
import { getSSHConfigPath, TempDir } from "@modular/pi-utils";
