...
import { Agent, type AgentMessage, type AgentTool, type StreamFn } from "@modular/pi-agent-core";
...
import { IrcBus, type IrcMessage } from "@modular/pi-coding-agent/irc/bus";
