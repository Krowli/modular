...
import { runOnboardingSetup } from "@modular/pi-coding-agent/commands/setup";
import { Settings } from "@modular/pi-coding-agent/config/settings";
import { SETTINGS_SCHEMA } from "@modular/pi-coding-agent/config/settings-schema";
import {
	ALL_SCENES,
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@modular/pi-coding-agent/modes/setup-wizard";
import { WebSearchTab } from "@modular/pi-coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@modular/pi-coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_PREFERENCES } from "@modular/pi-coding-agent/web/search/types";
...
describe("modular setup onboarding trigger", () => {
