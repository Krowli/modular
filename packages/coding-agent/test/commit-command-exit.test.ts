...
import CommitCommand from "@modular/pi-coding-agent/commands/commit";
import * as commitModule from "@modular/pi-coding-agent/commit";
import * as themeModule from "@modular/pi-coding-agent/modes/theme/theme";
import { postmortem } from "@modular/pi-utils";

describe("modular commit command lifecycle (issue #1041)", () => {
	afterEach(() => {
		vi.restoreAllMocks();
	});
