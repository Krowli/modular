...
import { SttClient } from "@modular/pi-coding-agent/stt/asr-client";
import type { SttWorkerInbound, SttWorkerOutbound } from "@modular/pi-coding-agent/stt/asr-protocol";
import { TinyTitleClient } from "@modular/pi-coding-agent/tiny/title-client";
import type { TinyTitleWorkerInbound, TinyTitleWorkerOutbound } from "@modular/pi-coding-agent/tiny/title-protocol";
