...
import type { AssistantMessage, Context, Message } from "@modular/pi-ai";
import {
	...
	SecretObfuscator,
} from "@modular/pi-coding-agent/secrets/obfuscator";
import { compileSecretRegex } from "@modular/pi-coding-agent/secrets/regex";
