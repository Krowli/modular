...
import { runConfigCommand } from "@modular/pi-coding-agent/cli/config-cli";
...
import { getConfigRootDir, setAgentDir, TempDir } from "@modular/pi-utils";
...
beforeEach(() => {
	...
	testAgentDir = TempDir.createSync("@modular-config-cli-");
