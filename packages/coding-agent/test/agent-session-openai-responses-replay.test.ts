...
import { createOpenAIResponsesHistoryPayload } from "@modular/pi-ai/utils";
...
import type { SessionEntry, SessionMessageEntry } from "@modular/pi-coding-agent/session/session-entries";
