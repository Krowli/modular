...
import { ExtensionList } from "@modular/pi-coding-agent/modes/components/extensions/extension-list";
import type { Extension } from "@modular/pi-coding-agent/modes/components/extensions/types";
import { HistorySearchComponent } from "@modular/pi-coding-agent/modes/components/history-search";
import { SessionSelectorComponent } from "@modular/pi-coding-agent/modes/components/session-selector";
import { TreeSelectorComponent } from "@modular/pi-coding-agent/modes/components/tree-selector";
import { UserMessageSelectorComponent } from "@modular/pi-coding-agent/modes/components/user-message-selector";
import { initTheme } from "@modular/pi-coding-agent/modes/theme/theme";
import { HistoryStorage } from "@modular/pi-coding-agent/session/history-storage";
import type { SessionTreeNode } from "@modular/pi-coding-agent/session/session-entries";
import type { SessionInfo } from "@modular/pi-coding-agent/session/session-listing";
import { setKeybindings } from "@modular/pi-tui";
...
async function createHistoryStorage(prompts: string[]): Promise<HistoryStorage> {
	const dir = TempDir.createSync("@modular-history-nav-");
	tempDirs.push(dir);
	HistoryStorage.resetInstance();
