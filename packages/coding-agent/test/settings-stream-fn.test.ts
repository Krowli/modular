...
import type { Context, Model, SimpleStreamOptions } from "@modular/pi-ai";
...
import { createSettingsAwareStreamFn } from "@modular/pi-coding-agent/session/settings-stream-fn";
