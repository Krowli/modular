...
import { Effort, type Model } from "@modular/pi-ai";
...
} from "@modular/pi-coding-agent/auto-thinking/classifier";
...
} from "@modular/pi-coding-agent/thinking";
import type { TinyMemoryLocalModelKey } from "@modular/pi-coding-agent/tiny/models";
import { tinyModelClient } from "@modular/pi-coding-agent/tiny/title-client";
...
describe("auto thinking classifier helpers", () => {
	...
	it("returns undefined for reasoning models without controllable efforts (devin-agent shape)", () => {
		// Repro for https://github.com/Krowli/modular/issues/3356 — Devin
