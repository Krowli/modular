...
import { loadCapability, setDisabledProviders } from "@modular/pi-coding-agent/capability";
import type { ContextFile } from "@modular/pi-coding-agent/capability/context-file";
import { clearCache } from "@modular/pi-coding-agent/capability/fs";
import type { Instruction } from "@modular/pi-coding-agent/capability/instruction";
import type { Prompt } from "@modular/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@modular/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@modular/pi-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@modular/pi-utils";
import "@modular/pi-coding-agent/capability/context-file";
import "@modular/pi-coding-agent/capability/instruction";
import "@modular/pi-coding-agent/capability/prompt";
import "@modular/pi-coding-agent/capability/rule";
import "@modular/pi-coding-agent/discovery/github";
