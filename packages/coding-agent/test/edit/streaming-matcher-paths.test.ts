 ...
 *
 * Regression: see https://github.com/Krowli/modular/issues/3646. Before the
...
import { EDIT_MODE_STRATEGIES } from "@modular/pi-coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@modular/pi-coding-agent/capability/rule";
