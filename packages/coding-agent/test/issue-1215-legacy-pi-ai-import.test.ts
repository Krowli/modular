...
describe("issue #1215: legacy @modular/pi-ai imports survive getResolvedSpecifier failure", () => {
	...
	beforeEach(() => {
		...
		// @modular/pi-ai so using it forces the import to be resolved at load time.
		fs.writeFileSync(
			extensionPath,
			[
