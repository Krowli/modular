...
import { Agent, type AgentMessage, type AgentTool } from "@modular/pi-agent-core";
import * as compactionModule from "@modular/pi-agent-core/compaction";
...
import { ExtensionRuntime, loadExtensionFromFactory } from "@modular/pi-coding-agent/extensibility/extensions/loader";
import { ExtensionRunner } from "@modular/pi-coding-agent/extensibility/extensions/runner";
import type { GoalModeState } from "@modular/pi-coding-agent/goals/state";
