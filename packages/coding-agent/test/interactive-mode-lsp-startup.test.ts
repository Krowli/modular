...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@modular/pi-coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@modular/pi-coding-agent/tools";
