...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@modular/pi-coding-agent/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "@modular/pi-coding-agent/tools/browser/tab-supervisor";
