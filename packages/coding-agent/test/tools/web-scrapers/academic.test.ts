...
import { handleArxiv } from "@modular/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@modular/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@modular/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@modular/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@modular/pi-coding-agent/web/scrapers/types";
