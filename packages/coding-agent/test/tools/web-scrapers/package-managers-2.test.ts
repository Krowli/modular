...
import { handleChocolatey } from "@modular/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@modular/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@modular/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@modular/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@modular/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@modular/pi-coding-agent/web/scrapers/terraform";
