...
import { handleBiorxiv } from "@modular/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@modular/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@modular/pi-coding-agent/web/scrapers/wikidata";
