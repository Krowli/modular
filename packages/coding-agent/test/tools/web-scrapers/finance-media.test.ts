...
import { handleArtifactHub } from "@modular/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@modular/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@modular/pi-coding-agent/web/scrapers/discogs";
