...
import { handleHuggingFace } from "@modular/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@modular/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@modular/pi-coding-agent/web/scrapers/vimeo";
