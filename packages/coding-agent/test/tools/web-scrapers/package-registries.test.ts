...
import { handleCratesIo } from "@modular/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@modular/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@modular/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@modular/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@modular/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@modular/pi-coding-agent/web/scrapers/pypi";
