...
import { handleAur } from "@modular/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@modular/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@modular/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@modular/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@modular/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@modular/pi-coding-agent/web/scrapers/rubygems";
