...
import { handleCheatSh } from "@modular/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@modular/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@modular/pi-coding-agent/web/scrapers/tldr";
