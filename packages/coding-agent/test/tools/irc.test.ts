...
import type { SettingPath } from "@modular/pi-coding-agent/config/settings-schema";
...
import type { CustomMessage } from "@modular/pi-coding-agent/session/messages";
...
import { IrcTool } from "@modular/pi-coding-agent/tools/irc";
