...
import type { SourceMeta } from "@modular/pi-coding-agent/capability/types";
import * as discovery from "@modular/pi-coding-agent/discovery";
import type { SSHHostInfo } from "@modular/pi-coding-agent/ssh/connection-manager";
import * as connectionManager from "@modular/pi-coding-agent/ssh/connection-manager";
import * as sshExecutor from "@modular/pi-coding-agent/ssh/ssh-executor";
import type { ToolSession } from "@modular/pi-coding-agent/tools";
import { loadSshTool } from "@modular/pi-coding-agent/tools/ssh";
...
const HOST_A: SSHHost = { name: `a-modular-test-${RUN_ID}`, host: "alpha.example.com", _source: SOURCE };
const HOST_B: SSHHost = { name: `b-modular-test-${RUN_ID}`, host: "beta.example.com", _source: SOURCE };
