 ...
 *
 * Regression for Krowli/modular#3639: before the fix, the advisor was built
...
import type { Model, SimpleStreamOptions } from "@modular/pi-ai";
import { streamSimple } from "@modular/pi-ai";
