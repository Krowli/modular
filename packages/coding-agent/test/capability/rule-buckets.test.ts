...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@modular/pi-coding-agent/capability/rule";
import { bucketRules } from "@modular/pi-coding-agent/capability/rule-buckets";
