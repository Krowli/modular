...
import type {
	...
	ExtensionUIContext,
} from "@modular/pi-coding-agent/extensibility/extensions";
import { ExtensionUiController } from "@modular/pi-coding-agent/modes/controllers/extension-ui-controller";
...
import { buildSessionContext, type SessionContext } from "@modular/pi-coding-agent/session/session-context";
import type { CustomMessageEntry, SessionEntry } from "@modular/pi-coding-agent/session/session-entries";
