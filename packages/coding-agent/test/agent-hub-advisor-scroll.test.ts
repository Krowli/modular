...
import type { AgentHubRemote } from "@modular/pi-coding-agent/modes/components/agent-hub";
...
import { CURRENT_SESSION_VERSION } from "@modular/pi-coding-agent/session/session-entries";
