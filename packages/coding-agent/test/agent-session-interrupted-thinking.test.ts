...
import type { Api, AssistantMessage, Model, ThinkingContent } from "@modular/pi-ai";
...
} from "@modular/pi-coding-agent/session/messages";
import type { SessionEntry } from "@modular/pi-coding-agent/session/session-entries";
