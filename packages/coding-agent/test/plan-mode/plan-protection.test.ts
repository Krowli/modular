...
import type { AgentToolCall } from "@modular/pi-agent-core";
import type { SessionMessageEntry } from "@modular/pi-agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@modular/pi-agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@modular/pi-agent-core/compaction/shake";
import type { ProtectedToolContext } from "@modular/pi-agent-core/compaction/tool-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@modular/pi-ai";
import { createPlanReadMatcher } from "@modular/pi-coding-agent/plan-mode/plan-protection";
