/**
 * Issue #2462: prompt templates discovered from `cwd/.modular/prompts/` were never
...
import { type Api, Effort, type Model } from "@modular/pi-ai";
import { ModelRegistry } from "@modular/pi-coding-agent/config/model-registry";
import type { PromptTemplate } from "@modular/pi-coding-agent/config/prompt-templates";
...
import type { AutocompleteProvider } from "@modular/pi-tui";
