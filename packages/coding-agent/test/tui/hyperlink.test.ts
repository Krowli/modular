...
import { LocalProtocolHandler } from "@modular/pi-coding-agent/internal-urls/local-protocol";
...
import {
	...
	urlHyperlink,
	urlHyperlinkAlways,
} from "@modular/pi-coding-agent/tui/hyperlink";
import * as terminalCaps from "@modular/pi-tui";
...
describe("tryResolveInternalUrlSync", () => {
	...
	it("returns undefined for unsupported internal URL schemes", () => {
		...
		expect(tryResolveInternalUrlSync("modular://docs.md")).toBeUndefined();
	});
