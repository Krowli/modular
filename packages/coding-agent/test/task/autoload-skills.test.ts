...
import * as skillsModule from "@modular/pi-coding-agent/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "@modular/pi-coding-agent/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@modular/pi-coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
