...
import type { ToolPathWithSource } from "@modular/pi-coding-agent/extensibility/custom-tools";
import type { LoadExtensionsResult } from "@modular/pi-coding-agent/extensibility/extensions/types";
import type { CreateAgentSessionResult } from "@modular/pi-coding-agent/sdk";
...
import { runSubprocess } from "@modular/pi-coding-agent/task/executor";
import type { AgentDefinition } from "@modular/pi-coding-agent/task/types";
...
describe("runSubprocess parent-discovery pass-through (issue #2190)", () => {
	...
	it("forwards rules, preloadedExtensionPaths, and preloadedCustomToolPaths to createAgentSession", async () => {
		...
		const preloadedExtensionPaths = ["/abs/parent/.modular/extensions/foo.ts"];
