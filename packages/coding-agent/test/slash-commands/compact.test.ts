...
import type { CompactOptions } from "@modular/pi-coding-agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@modular/pi-coding-agent/modes/types";
import type { CompactMode } from "@modular/pi-coding-agent/session/compact-modes";
import {
	ACP_BUILTIN_SLASH_COMMANDS,
	executeAcpBuiltinSlashCommand,
} from "@modular/pi-coding-agent/slash-commands/acp-builtins";
import { executeBuiltinSlashCommand } from "@modular/pi-coding-agent/slash-commands/builtin-registry";
import type { SlashCommandRuntime } from "@modular/pi-coding-agent/slash-commands/types";
