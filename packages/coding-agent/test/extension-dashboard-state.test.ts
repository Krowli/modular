...
import { applyDisabledExtensionsToState } from "@modular/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@modular/pi-coding-agent/modes/components/extensions/types";
