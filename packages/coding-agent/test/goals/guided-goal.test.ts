...
import * as core from "@modular/pi-agent-core";
import { ThinkingLevel } from "@modular/pi-agent-core";
import type { Api, Model } from "@modular/pi-ai";
...
import { runGuidedGoalTurn } from "@modular/pi-coding-agent/goals/guided-setup";
...
import { AgentSession as RealAgentSession } from "@modular/pi-coding-agent/session/agent-session";
