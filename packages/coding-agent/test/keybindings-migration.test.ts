...
import { matchesAppFollowUp } from "@modular/pi-coding-agent/modes/utils/keybinding-matchers";
import { type KeybindingsConfig, setKeybindings } from "@modular/pi-tui";
import {
...
`,
	...
	it("merges default user keybindings when create uses the active profile with no arguments (#4867)", async () => {
		...
		try {
			...
			restoreEnvValue("MODULAR_PROFILE", originalOmpProfile);
