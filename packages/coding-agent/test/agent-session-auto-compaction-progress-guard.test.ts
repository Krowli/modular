...
import { resolveThresholdTokens, shouldCompact } from "@modular/pi-agent-core/compaction";
...
import type { CompactionEntry } from "@modular/pi-coding-agent/session/session-entries";
import { SessionManager } from "@modular/pi-coding-agent/session/session-manager";
import { getProjectAgentDir, TempDir } from "@modular/pi-utils";
