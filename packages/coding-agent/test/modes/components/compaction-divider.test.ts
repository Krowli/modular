...
import { createCompactionSummaryMessage } from "@modular/pi-agent-core/compaction";
import type { ImageContent } from "@modular/pi-ai";
import { CompactionSummaryMessageComponent } from "@modular/pi-coding-agent/modes/components/compaction-summary-message";
