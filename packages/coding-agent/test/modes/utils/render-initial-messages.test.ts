 ...
 *
 * Also guards the cold-launch terminal cleanup: `modular` / `modular -c` leave the
...
import type { AssistantMessage, ImageContent, Usage } from "@modular/pi-ai";
import { kStreamingPartialJson } from "@modular/pi-ai/utils/block-symbols";
...
import type { SessionContext } from "@modular/pi-coding-agent/session/session-context";
import { SessionManager } from "@modular/pi-coding-agent/session/session-manager";
import { type Component, Container, Image, ImageProtocol, setTerminalImageProtocol, TERMINAL } from "@modular/pi-tui";
