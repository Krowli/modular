...
import type { AsyncJobRegisterOptions } from "@modular/pi-coding-agent/async/job-manager";
import { Settings } from "@modular/pi-coding-agent/config/settings";
import { TanCommandController } from "@modular/pi-coding-agent/modes/controllers/tan-command-controller";
import type { InteractiveModeContext } from "@modular/pi-coding-agent/modes/types";
import { AgentRegistry, MAIN_AGENT_ID } from "@modular/pi-coding-agent/registry/agent-registry";
...
function createContext(overrides?: {
	...
	const tempDir = TempDir.createSync("@modular-tan-controller-");
