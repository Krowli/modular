...
import type { ToolExecutionComponent } from "@modular/pi-coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@modular/pi-coding-agent/task/types";
import type { BashToolDetails } from "@modular/pi-coding-agent/tools/bash";
