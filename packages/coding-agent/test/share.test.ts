...
describe("normalizeShareServerUrl", () => {
	test("strips trailing slashes and falls back to the default", () => {
		expect(normalizeShareServerUrl("https://my.modularcli.com/s/")).toBe("https://my.modularcli.com/s");
		expect(normalizeShareServerUrl("https://example.com/s///")).toBe("https://example.com/s");
		expect(normalizeShareServerUrl(undefined)).toBe("https://my.modularcli.com/s");
		expect(normalizeShareServerUrl("   ")).toBe("https://my.modularcli.com/s");
	});
});
