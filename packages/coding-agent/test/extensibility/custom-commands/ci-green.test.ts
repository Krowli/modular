...
import { GreenCommand } from "@modular/pi-coding-agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@modular/pi-coding-agent/extensibility/typebox";
