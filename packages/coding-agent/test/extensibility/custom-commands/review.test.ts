...
import { ReviewCommand } from "@modular/pi-coding-agent/extensibility/custom-commands/bundled/review";
import type { CustomCommandAPI } from "@modular/pi-coding-agent/extensibility/custom-commands/types";
import type { HookCommandContext } from "@modular/pi-coding-agent/extensibility/hooks/types";
import type { SessionEntry } from "@modular/pi-coding-agent/session/session-entries";
import type { PrDiffPayload, ViewLookupResult } from "@modular/pi-coding-agent/tools/gh";
import * as gh from "@modular/pi-coding-agent/tools/gh";
...
describe("ReviewCommand", () => {
	...
	async function createTempDir(): Promise<string> {
		tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "modular-review-command-"));
		return tmpDir;
	}
