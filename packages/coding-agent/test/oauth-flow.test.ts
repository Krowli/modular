...
import { MCPOAuthFlow, refreshMCPOAuthToken } from "@modular/pi-coding-agent/mcp/oauth-flow";
...
describe("mcp oauth flow", () => {
	it("uses modular client name for dynamic client registration", async () => {
		...
		expect((registrationPayload as { client_name?: string } | null)?.client_name).toBe("modular");
