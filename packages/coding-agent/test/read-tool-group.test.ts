...
import { getDefault } from "@modular/pi-coding-agent/config/settings-schema";
import {
	ReadToolGroupComponent,
	readArgsTargetInternalUrl,
} from "@modular/pi-coding-agent/modes/components/read-tool-group";
...
describe("readArgsTargetInternalUrl", () => {
	it.each([
		...
		["modular://docs/tools/read.md"],
		["issue://123"],
		["pr://Krowli/modular/456"],
		["agent://abc"],
		["artifact://abc"],
		["memory://root"],
		["rule://name"],
