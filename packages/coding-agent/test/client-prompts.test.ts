...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@modular/pi-coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@modular/pi-coding-agent/mcp/types";
