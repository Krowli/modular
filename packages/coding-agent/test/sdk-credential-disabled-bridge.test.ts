...
import { AuthStorage, type CredentialDisabledEvent } from "@modular/pi-ai";
import * as oauthUtils from "@modular/pi-ai/oauth";
...
import type { Extension, ExtensionError, ExtensionFactory } from "@modular/pi-coding-agent/extensibility/extensions";
import { ExtensionRunner } from "@modular/pi-coding-agent/extensibility/extensions";
import { ExtensionRuntime } from "@modular/pi-coding-agent/extensibility/extensions/loader";
...
describe("createAgentSession credential_disabled subscription", () => {
	...
	const baseOptions = (dirs: SessionDirs, authStorage: AuthStorage, extensions: ExtensionFactory[] = []) => ({
		...
		// loads the developer's real ~/.modular models config on every construction (~100ms each,
