 ...
 * brush spawn). This test pulls the fix end-to-end through the MODULAR coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the MODULAR host process.
 */
...
import { createMockModel, type MockResponse } from "@modular/pi-ai/providers/mock";
...
import { BashTool, type ToolSession } from "@modular/pi-coding-agent/tools";
