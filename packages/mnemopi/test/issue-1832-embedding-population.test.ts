/**
 * Regression for https://github.com/Krowli/modular/issues/1832
 *
 * Before the fix:
...
import "./setup";
import { cmdRemember } from "@modular/pi-mnemopi/cli";
import { BeamMemory } from "@modular/pi-mnemopi/core/beam";
import { Mnemopi } from "@modular/pi-mnemopi/core/memory";
import {
	type ResolvedMnemopiRuntimeOptions,
	withMnemopiRuntimeOptions,
} from "@modular/pi-mnemopi/core/runtime-options";
