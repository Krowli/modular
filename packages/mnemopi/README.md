...
Local SQLite memory engine for Modular agents.
...
```ts
import { Mnemopi } from "@modular/pi-mnemopi";
...
The Modular coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
