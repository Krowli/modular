import { encodeSixel } from "@modular/pi-natives";
import { $env, isBunTestRuntime, isTerminalHeadless } from "@modular/pi-utils";
...
function osc99Id(id: string | undefined): string {
	return sanitizeOsc99Id(id) || `modular-${nextOsc99NotificationId++}`;
}
