...
import type { KeyEventType } from "@modular/pi-natives";
import {
 ...
 * `@modular/pi-tui` `Key` export verbatim so plugins built against any
 * scope alias (`@modular`, `@modular`, `@modular`) keep working
