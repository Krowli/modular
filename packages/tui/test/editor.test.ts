...
import { CURSOR_MARKER } from "@modular/pi-tui";
import { CombinedAutocompleteProvider } from "@modular/pi-tui/autocomplete";
import { Editor } from "@modular/pi-tui/components/editor";
import { KeybindingsManager, setKeybindings, TUI_KEYBINDINGS } from "@modular/pi-tui/keybindings";
import { setKittyProtocolActive } from "@modular/pi-tui/keys";
...
describe("Editor component", () => {
	...
	describe("Korean NFC paste normalization", () => {
		...
		// landed on the legacy `Input` component; MODULAR's interactive prompt
