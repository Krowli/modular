...
import { type Component, CURSOR_MARKER, type NativeScrollbackLiveRegion, TUI } from "@modular/pi-tui";
import { VirtualTerminal } from "./virtual-terminal";

// Regression test for https://github.com/Krowli/modular/issues/1974
//
...
/**
 * Minimal append-only live region. Models the real modular setup where
...
describe("issue #1974: tmux scrollback rendering", () => {
	...
	it("does not push chrome below the live block into pane history", async () => {
		// Models a real modular frame: streamed assistant reply on top, persistent
