/**
 * Shared wire types for the modular collab live-session protocol.
 *
 * Dependency-free JSON shapes produced by `@modular/pi-coding-agent`
...
export const DEFAULT_RELAY_URL = "wss://my.modularcli.com";

/** Default share viewer/upload base; `/share` links resolve against `<base>/<id>#<key>`. */
export const DEFAULT_SHARE_URL = "https://my.modularcli.com/s";
