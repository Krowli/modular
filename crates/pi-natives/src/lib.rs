//! Native utilities exported via N-API for the Modular toolchain.
//!
//! # Overview
...
/// [`modular_install_tokio_runtime`], which the JS loader calls once `dlopen` has
/// returned.
///
...
/// Guards [`modular_install_tokio_runtime`] so the runtime is built at most once
