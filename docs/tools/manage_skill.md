...
## Side Effects
- Filesystem: writes or deletes files under `~/.modular/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.modular/agent/managed-skills` and never edit user-authored skills.
