...
- syntax highlighting colors used by native highlighter (`@modular/pi-natives`)
...
- default agent dir: `~/.modular/agent`
- effective default file: `~/.modular/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.modular/agent/themes/my-theme.json`.
