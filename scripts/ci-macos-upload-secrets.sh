...
# terminal transcript.
#
# Prepare a directory (default ~/modular-signing) containing:
...
#   MODULAR_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/modular-signing
...
DIR="${DIR:-${MODULAR_SIGNING_DIR:-$HOME/modular-signing}}"
REPO="${MODULAR_REPO:-Krowli/modular}"
